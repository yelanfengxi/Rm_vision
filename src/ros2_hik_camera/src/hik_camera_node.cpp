...
private:
  void declareParameters()
  {
    ...
    // Set auto exposure and auto gain to Off
    MV_CC_SetEnumValueByString(camera_handle_, "ExposureAuto", "Off");
    ...
    RCLCPP_INFO(this->get_logger(), "Exposure time set to: %f", exposure_time);

    // Gain
    param_desc.description = "Gain";
    double gain = this->declare_parameter("gain", 15.0, param_desc);
