...
#include "auto_aim_interfaces/msg/detail/debug_armors__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const auto_aim_interfaces::msg::DebugArmor &,
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        auto_aim_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DebugArmor(
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::DebugArmors;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::DebugArmors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::DebugArmors *>(
    untyped_ros_message);
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_DebugArmors__handle;
}
